...
//        MyHelper.bitmapToMat(this._img, mat);
        ...
        Imgproc.cvtColor(mat, mat, Imgproc.COLOR_RGBA2GRAY, 1);
        ...
        hus.put(0,0, Math.log( Math.abs( hu.get(0,0)[0])) );
        hus.put(0,1, Math.log( Math.abs( hu.get(1,0)[0])) );
        hus.put(0,2, Math.log( Math.abs( hu.get(2,0)[0])) );
        hus.put(0,3, Math.log( Math.abs( hu.get(3,0)[0])) );
        hus.put(0,4, Math.log( Math.abs( hu.get(4,0)[0])) );
        hus.put(0,5, Math.log( Math.abs( hu.get(5,0)[0])) );
        hus.put(0,6, Math.log( Math.abs( hu.get(6,0)[0])) );


//        hus.put(0,0, -7.052961182704492 );
//        hus.put(0,1, -17.105173238264417 );
//        hus.put(0,2, -25.556416728730532 );
//        hus.put(0,3, -25.113520871042482 );
//        hus.put(0,4, -51.72874883379587 );
//        hus.put(0,5, -33.69703266685558 );
//        hus.put(0,6, -50.48869609498188 );
